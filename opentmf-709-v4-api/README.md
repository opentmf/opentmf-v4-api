...
Getter-only Java interfaces for **TMF-709 Test Scenario Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-709 specification. The corresponding model implementation lives in **opentmf-709-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-709-v4-api</artifactId>
