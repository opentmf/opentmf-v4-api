...
Getter-only Java interfaces for **TMF-710 General Test Artifact Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-710 specification. The corresponding model implementation lives in **opentmf-710-v4-model**
