...
Getter-only Java interfaces for **TMF-711 Shipment Management Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-711 specification. The corresponding model implementation lives in **opentmf-711-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-711-v4-api</artifactId>
