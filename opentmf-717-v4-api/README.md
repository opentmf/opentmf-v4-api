...
Getter-only Java interfaces for **TMF-717 Customer360 Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-717 specification. The corresponding model implementation lives in **opentmf-717-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-717-v4-api</artifactId>
