...
Getter-only Java interfaces for **TMF-921 Intent Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-921 specification. The corresponding model implementation lives in **opentmf-921-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-921-v4-api</artifactId>
