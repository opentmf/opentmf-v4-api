...
Getter-only Java interfaces for **TMF-699 Sales Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-699 specification. The corresponding model implementation lives in **opentmf-699-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-699-v4-api</artifactId>
