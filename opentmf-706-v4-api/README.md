...
Getter-only Java interfaces for **TMF-706 Test Data Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-706 specification. The corresponding model implementation lives in **opentmf-706-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-706-v4-api</artifactId>
