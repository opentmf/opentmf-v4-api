...
Getter-only Java interfaces for **TMF-708 Test Execution Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-708 specification. The corresponding model implementation lives in **opentmf-708-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-708-v4-api</artifactId>
