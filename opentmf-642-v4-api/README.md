...
Getter-only Java interfaces for **TMF-642 Alarm Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-642 specification. The corresponding model implementation lives in **opentmf-642-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-642-v4-api</artifactId>
