...
Getter-only Java interfaces for **TMF-688 Event Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-688 specification. The corresponding model implementation lives in **opentmf-688-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-688-v4-api</artifactId>
