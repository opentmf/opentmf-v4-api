...
import org.opentmf.common.model.ICategoryType;
 ...
 * @author Gökhan Demir
 */
public interface IIotDeviceUpdate extends IGSMACommons {
  ...
  List<? extends ICategoryType> getCategories();
   ...
   */
  List<? extends IDataAccessEndpoint> getDataAccessEndPoints();
