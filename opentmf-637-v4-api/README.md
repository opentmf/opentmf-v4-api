...
Getter-only Java interfaces for **TMF-637 Product Inventory Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-637 specification. The corresponding model implementation lives in **opentmf-637-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-637-v4-api</artifactId>
