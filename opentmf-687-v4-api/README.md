...
Getter-only Java interfaces for **TMF-687 Stock Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-687 specification. The corresponding model implementation lives in **opentmf-687-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-687-v4-api</artifactId>
