...
Getter-only Java interfaces for **TMF-671 Promotion Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-671 specification. The corresponding model implementation lives in **opentmf-671-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-671-v4-api</artifactId>
