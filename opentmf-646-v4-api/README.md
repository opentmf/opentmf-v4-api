...
Getter-only Java interfaces for **TMF-646 Appointment Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-646 specification. The corresponding model implementation lives in **opentmf-646-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-646-v4-api</artifactId>
