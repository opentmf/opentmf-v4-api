...
Getter-only Java interfaces for **TMF-681 Communication Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-681 specification. The corresponding model implementation lives in **opentmf-681-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-681-v4-api</artifactId>
