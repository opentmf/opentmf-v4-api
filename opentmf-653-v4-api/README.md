...
Getter-only Java interfaces for **TMF-653 Service Test Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-653 specification. The corresponding model implementation lives in **opentmf-653-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-653-v4-api</artifactId>
