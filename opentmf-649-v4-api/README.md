...
Getter-only Java interfaces for **TMF-649 Performance Thresholding Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-649 specification. The corresponding model implementation lives in **opentmf-649-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-649-v4-api</artifactId>
