 ...
 * @author Gökhan Demir
 */
public interface IVertexSpecificationCharacteristic extends ICharacteristicSpecificationBase {

  /**
   * An aggregation, migration, substitution, dependency or exclusivity
   * relationship between/among Specification Characteristics.
   */
  List<? extends IVertexSpecificationCharacteristicRelationship> getVertexSpecCharRelationships();
   ...
   * object can take on.
   */
  List<? extends ICharacteristicValueSpecification> getVertexSpecCharacteristicValues();
}
