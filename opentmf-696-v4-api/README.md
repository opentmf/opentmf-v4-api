...
Getter-only Java interfaces for **TMF-696 Risk Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-696 specification. The corresponding model implementation lives in **opentmf-696-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-696-v4-api</artifactId>
