...
Getter-only Java interfaces for **TMF-705 Test Environment Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-705 specification. The corresponding model implementation lives in **opentmf-705-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-705-v4-api</artifactId>
