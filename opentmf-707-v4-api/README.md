...
Getter-only Java interfaces for **TMF-707 Test Result Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-707 specification. The corresponding model implementation lives in **opentmf-707-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-707-v4-api</artifactId>
