...
Getter-only Java interfaces for **TMF-645 Service Qualification Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-645 specification. The corresponding model implementation lives in **opentmf-645-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-645-v4-api</artifactId>
