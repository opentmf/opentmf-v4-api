...
Getter-only Java interfaces for **TMF-664 Resource Function Activation Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-664 specification. The corresponding model implementation lives in **opentmf-664-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-664-v4-api</artifactId>
