...
Getter-only Java interfaces for **TMF-676 Payment Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-676 specification. The corresponding model implementation lives in **opentmf-676-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-676-v4-api</artifactId>
