...
Getter-only Java interfaces for **TMF-620 Product Catalog Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-620 specification. The corresponding model implementation lives in **opentmf-620-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-620-v4-api</artifactId>
