...
Getter-only Java interfaces for **TMF-640 Service Activation Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-640 specification. The corresponding model implementation lives in **opentmf-640-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-640-v4-api</artifactId>
