...
Getter-only Java interfaces for **TMF-691 Federated ID Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-691 specification. The corresponding model implementation lives in **opentmf-691-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-691-v4-api</artifactId>
