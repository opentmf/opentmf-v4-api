...
Getter-only Java interfaces for **TMF-629 Customer Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-629 specification. The corresponding model implementation lives in **opentmf-629-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-629-v4-api</artifactId>
