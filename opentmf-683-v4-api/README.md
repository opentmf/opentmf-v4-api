...
Getter-only Java interfaces for **TMF-683 Party Interaction Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-683 specification. The corresponding model implementation lives in **opentmf-683-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-683-v4-api</artifactId>
