...
Getter-only Java interfaces for **TMF-657 Service Quality Management Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-657 specification. The corresponding model implementation lives in **opentmf-657-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-657-v4-api</artifactId>
