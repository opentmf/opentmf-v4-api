...
Getter-only Java interfaces for **TMF-632 Party Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-632 specification. The corresponding model implementation lives in **opentmf-632-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-632-v4-api</artifactId>
