...
Getter-only Java interfaces for **TMF-633 Service Catalog Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-633 specification. The corresponding model implementation lives in **opentmf-633-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-633-v4-api</artifactId>
