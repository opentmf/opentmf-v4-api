...
Getter-only Java interfaces for **TMF-658 Loyalty**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-658 specification. The corresponding model implementation lives in **opentmf-658-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-658-v4-api</artifactId>
