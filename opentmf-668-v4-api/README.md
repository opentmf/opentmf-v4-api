...
Getter-only Java interfaces for **TMF-668 Partnership Type**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-668 specification. The corresponding model implementation lives in **opentmf-668-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-668-v4-api</artifactId>
