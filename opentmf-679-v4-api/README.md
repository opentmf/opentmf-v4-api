...
Getter-only Java interfaces for **TMF-679 Product Offering Qualification Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-679 specification. The corresponding model implementation lives in **opentmf-679-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-679-v4-api</artifactId>
