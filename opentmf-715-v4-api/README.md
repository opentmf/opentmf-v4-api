...
Getter-only Java interfaces for **TMF-715 Warranty Management**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-715 specification. The corresponding model implementation lives in **opentmf-715-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-715-v4-api</artifactId>
