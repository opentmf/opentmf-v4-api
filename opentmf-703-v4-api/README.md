...
Getter-only Java interfaces for **TMF-703 Entity Inventory Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-703 specification. The corresponding model implementation lives in **opentmf-703-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-703-v4-api</artifactId>
