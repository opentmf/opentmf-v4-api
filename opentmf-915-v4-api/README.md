...
Getter-only Java interfaces for **TMF-915 AI Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-915 specification. The corresponding model implementation lives in **opentmf-915-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-915-v4-api</artifactId>
