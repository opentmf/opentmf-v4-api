...
Getter-only Java interfaces for **TMF-654 Prepay Balance Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-654 specification. The corresponding model implementation lives in **opentmf-654-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-654-v4-api</artifactId>
