...
Getter-only Java interfaces for **TMF-621 Trouble Ticket Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-621 specification. The corresponding model implementation lives in **opentmf-621-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-621-v4-api</artifactId>
