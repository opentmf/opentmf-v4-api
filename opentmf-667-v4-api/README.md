...
Getter-only Java interfaces for **TMF-667 Document Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-667 specification. The corresponding model implementation lives in **opentmf-667-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-667-v4-api</artifactId>
