...
Getter-only Java interfaces for **TMF-666 Account Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-666 specification. The corresponding model implementation lives in **opentmf-666-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-666-v4-api</artifactId>
