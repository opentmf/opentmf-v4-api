...
Getter-only Java interfaces for **TMF-701 Process Flow Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-701 specification. The corresponding model implementation lives in **opentmf-701-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-701-v4-api</artifactId>
