...
Getter-only Java interfaces for **TMF-700 Shipping Order Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-700 specification. The corresponding model implementation lives in **opentmf-700-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-700-v4-api</artifactId>
