...
Getter-only Java interfaces for **TMF-670 Payment Method Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-670 specification. The corresponding model implementation lives in **opentmf-670-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-670-v4-api</artifactId>
