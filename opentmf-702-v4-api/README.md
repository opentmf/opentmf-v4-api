...
Getter-only Java interfaces for **TMF-702 Resource Activation Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-702 specification. The corresponding model implementation lives in **opentmf-702-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-702-v4-api</artifactId>
