...
Getter-only Java interfaces for **TMF-675 Geographic Location Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-675 specification. The corresponding model implementation lives in **opentmf-675-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-675-v4-api</artifactId>
