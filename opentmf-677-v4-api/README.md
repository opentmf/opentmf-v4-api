...
Getter-only Java interfaces for **TMF-677 Usage Consumption Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-677 specification. The corresponding model implementation lives in **opentmf-677-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-677-v4-api</artifactId>
