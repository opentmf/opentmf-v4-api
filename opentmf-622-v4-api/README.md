...
Getter-only Java interfaces for **TMF-622 Product Ordering Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-622 specification. The corresponding model implementation lives in **opentmf-622-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-622-v4-api</artifactId>
