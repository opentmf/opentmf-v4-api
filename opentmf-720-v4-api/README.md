...
Getter-only Java interfaces for **TMF-720 Digital Identity Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-720 specification. The corresponding model implementation lives in **opentmf-720-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-720-v4-api</artifactId>
