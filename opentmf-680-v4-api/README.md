...
Getter-only Java interfaces for **TMF-680 Recommendation Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-680 specification. The corresponding model implementation lives in **opentmf-680-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-680-v4-api</artifactId>
