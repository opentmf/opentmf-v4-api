...
Getter-only Java interfaces for **TMF-662 Entity Catalog Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-662 specification. The corresponding model implementation lives in **opentmf-662-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-662-v4-api</artifactId>
