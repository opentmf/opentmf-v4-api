...
Getter-only Java interfaces for **TMF-714 Work Qualification Management**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-714 specification. The corresponding model implementation lives in **opentmf-714-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-714-v4-api</artifactId>
