...
Getter-only Java interfaces for **TMF-673 Geographic Address Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-673 specification. The corresponding model implementation lives in **opentmf-673-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-673-v4-api</artifactId>
