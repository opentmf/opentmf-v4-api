 ...
 * @author Gökhan Demir
 */
public interface IMetadataCatalogItemUpdate extends IPromotionUpdateBase {
   ...
   * application.
   */
  List<? extends IMetadataCategoryRef> getCategories();

  /**
   * reference to an MetadataSpecification object.
   */
  IMetadataSpecificationRef getSpecification();
}
