...
Getter-only Java interfaces for **TMF-725 Metadata Catalog Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-725 specification. The corresponding model implementation lives in **opentmf-725-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-725-v4-api</artifactId>
