...
Getter-only Java interfaces for **TMF-641 Service Ordering Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-641 specification. The corresponding model implementation lives in **opentmf-641-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-641-v4-api</artifactId>
