...
Getter-only Java interfaces for **TMF-639 Resource Inventory Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-639 specification. The corresponding model implementation lives in **opentmf-639-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-639-v4-api</artifactId>
