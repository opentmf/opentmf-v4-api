...
Getter-only Java interfaces for **TMF-672 User Role Permission Management API**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-672 specification. The corresponding model implementation lives in **opentmf-672-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-672-v4-api</artifactId>
