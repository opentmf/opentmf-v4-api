...
Getter-only Java interfaces for **TMF-713 Work Management**.

This module contains `I*` interfaces that define the read contract for every model class in the
TMF-713 specification. The corresponding model implementation lives in **opentmf-713-v4-model**
...
<dependency>
    ...
    <artifactId>opentmf-713-v4-api</artifactId>
